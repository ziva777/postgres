				   ...
				   bool is_toast)
{
	...
	if (is_toast)
	{
		...
		hdr->pd_special = ToastPageSpecialOffset;
	...
	else
	{
		...
		hdr->pd_special = HeapPageSpecialOffset;
				   ...
				   bool try_double_xmax)
{
	...
	*new_hdr = *hdr;
	...
	if (toast)
		special_fits = ToastPageSpecialOffset >=
						new_hdr->pd_lower + occupied_space;
	else
		special_fits = HeapPageSpecialOffset >=
						new_hdr->pd_lower + occupied_space;
