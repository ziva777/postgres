...
$node1->init;
$off1 = current_mxoff($node1);
mxact_eater($node1, "FOO");
$off2 = current_mxoff($node1);
...
$off1 = current_mxoff($node2);
mxact_eater($node2, "FOO");
$off2 = current_mxoff($node2);
note "> start from $off1, finished at $off2\n";
...
$off1 = current_mxoff($node3);
mxact_eater($node3, "FOO");
$off2 = current_mxoff($node3);
note "> start from $off1, finished at $off2\n";
